      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        >
          ...
          <div className="space-y-2">
            <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black tracking-tighter text-black uppercase leading-[1.05]">
              Hi, I&apos;m{" "}
              <span className="block">
                {portfolioData.personal.name}
              </span>
            </h1>
            <div className="h-10 sm:h-12 flex items-center justify-center lg:justify-start mt-4">
              <span className="text-2xl sm:text-4xl font-extrabold text-black uppercase tracking-tight">
                {displayedText}
              </span>
              <span className="w-1 sm:w-2 h-6 sm:h-8 ml-2 bg-black animate-pulse inline-block" />
            </div>
          </div>
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-4">
            <a
              href="#projects"
              className="inline-flex items-center gap-2 px-6 py-3 text-sm font-bold text-white bg-black hover:bg-gray-800 rounded-full transition-all duration-200 shadow-md hover:scale-[1.02]"
            >
              Explore Projects
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-5 py-3 text-sm font-bold text-black border border-black hover:bg-black/5 rounded-full transition-colors"
            >
              Let&apos;s Connect
            </a>
          </div>
          ...
          <div className="pt-4 flex items-center justify-center lg:justify-start gap-3 text-gray-500">
            <a
              href={portfolioData.social.github}
              target="_blank"
              rel="noopener noreferrer"
              className="p-2.5 rounded-full bg-black/[0.03] hover:bg-black/[0.08] border border-black/[0.08] hover:text-black transition-colors"
        ...
        >
          <div className="relative group">
            ...
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full p-2 bg-white border-2 border-black shadow-2xl animate-float overflow-hidden">
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -left-4 sm:bottom-4 sm:-left-6 px-4 py-2 rounded-2xl bg-black border-2 border-black shadow-xl flex items-center gap-2.5"
            >
